...
| components.istio.cni.resources | object | `{}` |  |
| components.istio.cni.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.istio.cni.tolerations[0].operator | string | `"Exists"` |  |
| components.istio.cni.tolerations[1].effect | string | `"NoSchedule"` |  |
| components.istio.cni.tolerations[1].key | string | `"node.ssc-spc.gc.ca/purpose"` |  |
| components.istio.cni.tolerations[1].operator | string | `"Exists"` |  |
...
| components.istio.ztunnel.resources | object | `{}` |  |
| components.istio.ztunnel.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.istio.ztunnel.tolerations[0].operator | string | `"Exists"` |  |
| components.istio.ztunnel.tolerations[1].effect | string | `"NoSchedule"` |  |
| components.istio.ztunnel.tolerations[1].key | string | `"node.ssc-spc.gc.ca/purpose"` |  |
| components.istio.ztunnel.tolerations[1].operator | string | `"Exists"` |  |
...
| components.strimzi.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.labelSelector.matchLabels.app | string | `"strimzi"` |  |
| components.strimzi.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].podAffinityTerm.topologyKey | string | `"kubernetes.io/hostname"` |  |
| components.strimzi.affinity.podAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution[0].weight | int | `1` |  |
...
| components.strimzi.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.strimzi.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.strimzi.priorityClassName | string | `"platform-cluster-medium"` |  |
| components.strimzi.replicas | int | `1` |  |
| components.strimzi.resources | object | `{}` |  |
| components.strimzi.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.strimzi.tolerations[0].operator | string | `"Exists"` |  |
