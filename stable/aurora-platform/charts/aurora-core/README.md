...
| components.certManager.prometheus.servicemonitor.targetPort | int | `9402` |  |
...
| components.cilium.ciliumBGPClusterConfig.bgpInstances | list | `[]` |  |
| components.cilium.ciliumBGPClusterConfig.nodeSelector.matchLabels."kubernetes.io/os" | string | `"linux"` |  |
...
| components.cilium.k8sServiceHost | string | `""` |  |
...
| components.keda.affinity | object | `{}` |  |
| components.keda.enabled | bool | `false` |  |
| components.keda.helm.targetRevision | string | `"2.20.2"` |  |
| components.keda.images.keda.image.registry | string | `"ghcr.io"` |  |
| components.keda.images.keda.image.repository | string | `"kedacore/keda"` |  |
| components.keda.images.keda.image.tag | string | `""` |  |
| components.keda.images.metricsApiServer.image.registry | string | `"ghcr.io"` |  |
| components.keda.images.metricsApiServer.image.repository | string | `"kedacore/keda-metrics-apiserver"` |  |
| components.keda.images.metricsApiServer.image.tag | string | `""` |  |
| components.keda.images.webhooks.image.registry | string | `"ghcr.io"` |  |
| components.keda.images.webhooks.image.repository | string | `"kedacore/keda-admission-webhooks"` |  |
| components.keda.images.webhooks.image.tag | string | `""` |  |
| components.keda.nodeSelector | object | `{}` |  |
| components.keda.priorityClassName | string | `""` |  |
| components.keda.prometheus.enabled | bool | `false` |  |
| components.keda.prometheus.servicemonitor.enabled | bool | `false` |  |
| components.keda.resources | object | `{}` |  |
| components.keda.tolerations | list | `[]` |  |
...
| components.kubecost.aggregator.image.registry | string | `""` |  |
| components.kubecost.aggregator.image.repository | string | `"kubecost/cost-model"` |  |
| components.kubecost.aggregator.image.tag | string | `""` |  |
| components.kubecost.aggregator.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.aggregator.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.aggregator.priority.enabled | bool | `true` |  |
| components.kubecost.aggregator.priority.name | string | `"system-cluster-critical"` |  |
| components.kubecost.aggregator.resources.limits | object | `{}` |  |
| components.kubecost.aggregator.resources.requests.cpu | string | `"100m"` |  |
| components.kubecost.aggregator.resources.requests.memory | string | `"3Gi"` |  |
| components.kubecost.aggregator.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.aggregator.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.cloudCost.affinity | object | `{}` |  |
| components.kubecost.cloudCost.enabled | bool | `false` |  |
| components.kubecost.cloudCost.fullImageName | string | `""` |  |
| components.kubecost.cloudCost.image.registry | string | `""` |  |
| components.kubecost.cloudCost.image.repository | string | `"kubecost/cost-model"` |  |
| components.kubecost.cloudCost.image.tag | string | `""` |  |
| components.kubecost.cloudCost.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.cloudCost.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.cloudCost.resources | object | `{}` |  |
| components.kubecost.cloudCost.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.cloudCost.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.clusterController.affinity | object | `{}` |  |
| components.kubecost.clusterController.enabled | bool | `false` |  |
| components.kubecost.clusterController.fullImageName | string | `""` |  |
| components.kubecost.clusterController.image.registry | string | `""` |  |
| components.kubecost.clusterController.image.repository | string | `"kubecost/cluster-controller"` |  |
| components.kubecost.clusterController.image.tag | string | `"v0.16.32"` |  |
| components.kubecost.clusterController.imagePullPolicy | string | `"IfNotPresent"` |  |
| components.kubecost.clusterController.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.clusterController.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.clusterController.priorityClassName | string | `"system-cluster-critical"` |  |
| components.kubecost.clusterController.resources | object | `{}` |  |
| components.kubecost.clusterController.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.clusterController.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.enabled | bool | `false` |  |
| components.kubecost.finopsagent.affinity | object | `{}` |  |
| components.kubecost.finopsagent.image.digest | string | `""` |  |
| components.kubecost.finopsagent.image.pullPolicy | string | `"IfNotPresent"` |  |
| components.kubecost.finopsagent.image.registry | string | `""` |  |
| components.kubecost.finopsagent.image.repository | string | `"ibm-finops/agent"` |  |
| components.kubecost.finopsagent.image.tag | string | `"v1.0.10"` |  |
| components.kubecost.finopsagent.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.finopsagent.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.finopsagent.priorityClassName | string | `"system-cluster-critical"` |  |
| components.kubecost.finopsagent.resources | object | `{}` |  |
| components.kubecost.finopsagent.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.finopsagent.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.forecasting.affinity | object | `{}` |  |
| components.kubecost.forecasting.enabled | bool | `false` |  |
| components.kubecost.forecasting.fullImageName | string | `""` |  |
| components.kubecost.forecasting.image.registry | string | `""` |  |
| components.kubecost.forecasting.image.repository | string | `"kubecost/modeling"` |  |
| components.kubecost.forecasting.image.tag | string | `"v0.1.34"` |  |
| components.kubecost.forecasting.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.forecasting.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.forecasting.priority.enabled | bool | `true` |  |
| components.kubecost.forecasting.priority.name | string | `"system-cluster-critical"` |  |
| components.kubecost.forecasting.resources.limits.cpu | string | `"1500m"` |  |
| components.kubecost.forecasting.resources.limits.memory | string | `"1Gi"` |  |
| components.kubecost.forecasting.resources.requests.cpu | string | `"200m"` |  |
| components.kubecost.forecasting.resources.requests.memory | string | `"300Mi"` |  |
| components.kubecost.forecasting.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.forecasting.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.frontend.affinity | object | `{}` |  |
| components.kubecost.frontend.fullImageName | string | `""` |  |
| components.kubecost.frontend.image.registry | string | `""` |  |
| components.kubecost.frontend.image.repository | string | `"kubecost/frontend"` |  |
| components.kubecost.frontend.image.tag | string | `""` |  |
| components.kubecost.frontend.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.frontend.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.frontend.priority.enabled | bool | `true` |  |
| components.kubecost.frontend.priority.name | string | `"system-cluster-critical"` |  |
| components.kubecost.frontend.resources.requests.cpu | string | `"10m"` |  |
...
| components.kubecost.kubecostProductConfigs.labelMappingConfigs.owner_label | string | `"project.ssc-spc.gc.ca/lead"` |  |
| components.kubecost.kubecostProductConfigs.labelMappingConfigs.product_label | string | `"finance.ssc-spc.gc.ca/workload-id"` |  |
| components.kubecost.kubecostProductConfigs.labelMappingConfigs.team_label | string | `"project.ssc-spc.gc.ca/team"` |  |
| components.kubecost.kubecostProductConfigs.productKey.enabled | bool | `false` |  |
| components.kubecost.kubecostProductConfigs.productKey.key | string | `""` |  |
| components.kubecost.kubecostProductConfigs.productKey.mountPath | string | `""` |  |
| components.kubecost.kubecostProductConfigs.productKey.secretname | string | `""` |  |
| components.kubecost.localStore.affinity | object | `{}` |  |
| components.kubecost.localStore.fullImageName | string | `""` |  |
| components.kubecost.localStore.image.registry | string | `""` |  |
| components.kubecost.localStore.image.repository | string | `"kubecost/cost-model"` |  |
| components.kubecost.localStore.image.tag | string | `""` |  |
| components.kubecost.localStore.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.localStore.nodeSelector."node.ssc-spc.gc.ca/purpose" | string | `"system"` |  |
| components.kubecost.localStore.resources | object | `{}` |  |
| components.kubecost.localStore.tolerations[0].key | string | `"CriticalAddonsOnly"` |  |
| components.kubecost.localStore.tolerations[0].operator | string | `"Exists"` |  |
| components.kubecost.networkCosts.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms[0].matchExpressions[0].key | string | `"topology.kubernetes.io/region"` |  |
| components.kubecost.networkCosts.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms[0].matchExpressions[0].operator | string | `"Exists"` |  |
| components.kubecost.networkCosts.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms[0].matchExpressions[1].key | string | `"topology.kubernetes.io/zone"` |  |
| components.kubecost.networkCosts.affinity.nodeAffinity.requiredDuringSchedulingIgnoredDuringExecution.nodeSelectorTerms[0].matchExpressions[1].operator | string | `"Exists"` |  |
| components.kubecost.networkCosts.fullImageName | string | `""` |  |
| components.kubecost.networkCosts.image.registry | string | `""` |  |
| components.kubecost.networkCosts.image.repository | string | `"kubecost/network-costs"` |  |
| components.kubecost.networkCosts.image.tag | string | `"v0.18.2"` |  |
| components.kubecost.networkCosts.nodeSelector."kubernetes.io/os" | string | `"linux"` |  |
| components.kubecost.networkCosts.priorityClassName | string | `"system-cluster-critical"` |  |
| components.kubecost.networkCosts.resources.limits.cpu | string | `"500m"` |  |
| components.kubecost.networkCosts.resources.requests.cpu | string | `"50m"` |  |
| components.kubecost.networkCosts.resources.requests.memory | string | `"20Mi"` |  |
...
| components.kubecost.networkCosts.tolerations[1].key | string | `"node.ssc-spc.gc.ca/purpose"` |  |
| components.kubecost.networkCosts.tolerations[1].operator | string | `"Exists"` |  |
| components.ntp.enabled | bool | `true` |  |
| components.ntp.image.repository | string | `"ubuntu"` |  |
| components.ntp.image.tag | string | `"22.04"` |  |
...
| components.ntp.resources.limits.cpu | string | `"50m"` |  |
| components.ntp.resources.limits.memory | string | `"512Mi"` |  |
| components.ntp.resources.requests.cpu | string | `"10m"` |  |
| components.ntp.resources.requests.memory | string | `"64Mi"` |  |
...
| components.prometheus.msteams.helm.targetRevision | string | `"1.3.0"` |  |
...
| components.tetragon.operator.image.tag | string | `"v1.6.0"` |  |
